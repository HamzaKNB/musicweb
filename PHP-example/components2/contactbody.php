...
<body>
<div class="overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white m-4 font-[sans-serif]">
      <div
        class="grid md:grid-cols-2 items-center">
        <div class="p-8 bg-gray-900">
          <h2 class="text-3xl text-white">Get In <span class="text-yellow-400">Touch</span></h2>
          <p class="text-sm text-gray-400 mt-4 leading-relaxed">Have a specific inquiry or looking to explore new opportunities? Our
          ...
          <form>
            ...
            <button type="button"
              class="mt-8 flex items-center justify-center text-sm w-full rounded-md px-4 py-2.5 tracking-wide text-gray-800 bg-yellow-400 hover:bg-yellow-500">
